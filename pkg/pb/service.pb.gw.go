...
func request_Helloworld_GetVersion_0(ctx context.Context, marshaler runtime.Marshaler, client HelloworldClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterHelloworldHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HelloworldClient) error {
	...
	mux.Handle("GET", pattern_Helloworld_GetVersion_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Helloworld_GetVersion_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Helloworld_GetVersion_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Helloworld_GetVersion_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"version"}, ""))

	pattern_Helloworld_HelloWorld_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"hello"}, ""))
)

var (
	forward_Helloworld_GetVersion_0 = runtime.ForwardResponseMessage
